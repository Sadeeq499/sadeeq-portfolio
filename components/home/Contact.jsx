          ...
          <div className="space-y-8">
            ...
            <div className="space-y-4 py-6">
              <div className="flex items-center gap-3">
                <FaEnvelope className="text-[#FF014F] w-5 h-5 flex-shrink-0" />
                <a
                  href="mailto:muhammadsadeeq11223@gmail.com"
                  className="text-gray-300 hover:text-[#FF014F] transition-colors duration-300"
                >
                  muhammadsadeeq11223@gmail.com
                </a>
              </div>
              <div className="flex items-center gap-3">
                <svg
                  className="text-[#FF014F] w-5 h-5 flex-shrink-0"
                  fill="currentColor"
                  viewBox="0 0 20 20"
                >
